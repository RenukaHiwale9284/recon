...
public class GenTableDefinition implements Serializable 
	{	
	int projectId ;
	String tableName ;
	...
	public GenTableDefinition(int pid, String tbl) {
		this.projectId = pid ;
		this.tableName = tbl ;	
	}
	...
	public int getTableSize()
		{
		ArrayList<String> dd = getList();
		return dd.size() ;
		}
	
	
	public void setHeaders(ArrayList<String> d)
		{		
	...
	public ArrayList<String> getList()
		...
		dd.add(v1) ;
		if(v2 == null) return dd ;
		
		dd.add(v2) ;
		if(v3 == null) return dd ;
		
		dd.add(v3) ;
		if(v4 == null) return dd ;

		dd.add(v4) ;
		if(v5 == null) return dd ;
		
		dd.add(v5) ;
		if(v6 == null) return dd ;

		dd.add(v6) ;
		if(v7 == null) return dd ;
		
		dd.add(v7) ;
		if(v8 == null) return dd ;
		
		dd.add(v8) ;
		if(v9 == null) return dd ;
		
		dd.add(v9) ;
		if(v10 == null) return dd ;

		dd.add(v10) ;
		if(v11 == null) return dd ;
		
		dd.add(v11) ;
		if(v12 == null) return dd ;
	
		dd.add(v12) ;
		if(v13 == null) return dd ;
		
		dd.add(v13) ;
		if(v14 == null) return dd ;
		
		dd.add(v14) ;
		if(v15 == null) return dd ;
		
		dd.add(v15) ;
		if(v16 == null) return dd ;

		dd.add(v16) ;
		if(v17 == null) return dd ;
		
		dd.add(v17) ;
		if(v18 == null) return dd ;
		
		dd.add(v18) ;
		if(v19 == null) return dd ;
		
		dd.add(v19) ;
		if(v20 == null) return dd ;
