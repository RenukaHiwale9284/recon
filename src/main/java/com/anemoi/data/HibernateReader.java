...
public class HibernateReader {
	...
	public HibernateReader(int proj) {
		this.projectId = proj;
	}
...
//		String hql = "select S.partyName, sum(S.invoiceAmount) from SalesRecord as S where S.projectId = " + this.projectId + " group by S.partyName ";
		String hql = "select S.partyName, sum(S.invoiceAmount) from SalesRecord as S where S.projectId = :projectId group by S.partyName ";

		Query qq = session.createQuery(hql);
		qq.setParameter("projectId", this.projectId);
	...
	public IncomeDocument readRPTAggr() {
		...
		// bk.writer having avg(bk.price) > 100";
		String hql = "select S.partyName, sum(S.amount) from RPTRecord as S where S.projectId = :projectId  group by S.partyName ";
	...
	public IncomeDocument read26ASAggr() {
		...
		String hql = "select S.partyName, sum(S.tac), sum(S.ttd) from PartyRecord as S where S.projectId = :projectId  group by S.partyName ";
	...
	public HashMap<String, Double> readTDSAggr() {
		...
		String hql = "select S.partyName, sum(S.ttd) from PartyRecord as S where S.projectId =  :projectId  group by S.partyName ";
	...
	public List<DataSummmary> readSummary() {
		...
		String hql = "select count(distinct S.partyName) from PartyRecord as S where S.projectId = :projectId ";
...
//			as26.setTotalTax((Double) row26as[2] );
		...
		hql = "select count(*), sum(amountOfRefund) from Refund as S where S.projectId = :projectId ";

		qq = session.createQuery(hql);
		qq.setParameter("projectId", this.projectId);
		list = qq.list();
		...
		hql = "select count(distinct S.partyName), count(*), sum(invoiceAmount)  from SalesRecord as S where S.projectId = :projectId ";
		...
		hql = "select count(distinct  S.partyName), sum(amount)  from RPTRecord as S where S.projectId = :projectId ";
	...
	public static void main(String[] argv) {
		HibernateReader br = new HibernateReader(65);
...
//		for(ItaaTaxRate o : br.readItaa())	 o.show();
	...
	public List<IncomeAmount> readIncomeAmount() {
		String hql = "from IncomeAmount as S where S.projectId = :projectId ";

		System.out.print("\nHibernate : get List :" + hql);
		Session session = HibernateUtil.getSessionFactory().openSession();

		Query<IncomeAmount> query = session.createQuery(hql);
		query.setParameter("projectId", this.projectId);
	...
	public List<TDS> readTDS() {
		String hql = "from TDS as S where S.projectId = :projectId ";
		System.out.print("\nHibernate : get List :" + hql);
	...
	public List<RPTRecord> readRPT() {
		String hql = "from RPTRecord as S where S.projectId = :projectId ";
		System.out.print("\nHibernate : get List :" + hql);
		Session session = HibernateUtil.getSessionFactory().openSession();
	...
	public List<SalesRecord> readSR() {
		String hql = "from SalesRecord as S where S.projectId = :projectId ";
		System.out.print("\nHibernate : get List :" + hql);
		Session session = HibernateUtil.getSessionFactory().openSession();
	...
	public List<PartyRecord> read26ASParty() {
		String hql = "from PartyRecord as S where S.projectId = :projectId ";
		System.out.print("\nHibernate : get List :" + hql);
		Session session = HibernateUtil.getSessionFactory().openSession();
	...
	public List<Refund> readRefund() {
		String hql = "from Refund as S where S.projectId = :projectId ";
		System.out.print("\nHibernate : get List :" + hql);
		Session session = HibernateUtil.getSessionFactory().openSession();
	...
	public NameData readNames() {
		String hql = "from NameData as S where S.projectId = :projectId  ";
		System.out.print("\nHibernate : get List :" + hql);
		Session session = HibernateUtil.getSessionFactory().openSession();
	...
	public List<TaxPosition> readTaxPositions() {
		String hql = "from TaxPosition as S where S.projectId = :projectId ";
